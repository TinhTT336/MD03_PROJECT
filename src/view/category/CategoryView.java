...
//            System.out.println(PURPLE + ".----------------------------------------------------------------------------------------------------------------.");
//            System.out.println("|" + RESET + "      ID      |             DANH MỤC                |                 MÔ TẢ                |     TRẠNG THÁI     " + PURPLE + "|");
//            System.out.println("|----------------------------------------------------------------------------------------------------------------|");
//            System.out.printf(WHITE + "|      %-8d|     %-32s|         %-29s| %-16s   |\n",
//                    hiddenCategory.getId(), hiddenCategory.getCategoryName(), hiddenCategory.getDescription(), (hiddenCategory.isStatus() ? "Hoạt động" : "Ngừng kinh doanh"));
//            System.out.println(PURPLE + "'----------------------------------------------------------------------------------------------------------------'" + RESET);
    ...
    public void findCategoryByName() {
        ...
        if (count > 0) {
            showTLine();
            System.out.println("Tìm được " + count + " danh mục theo tên danh mục " + "'" + catName + "'" + " vừa nhập");
            System.out.println();
        } else {
    ...
    public void findTrueCategoryByName() {
        System.out.println("Nhập tên danh mục muốn tìm kiếm: ");
        String catName = Validation.validateString();
        int count = 0;
        showTHead();
    ...
    public void addCategory() {
        ...
        for (int i = 0; i < n; i++) {
            if (n > 1) {
                System.out.println("Thêm mới danh mục thứ " + (i + 1));
            }
            ...
            if (n > 1) {
                System.out.println(PURPLE + "Thêm mới danh mục thứ " + (i + 1) + " thành công!!!" + RESET);
            } else {
                System.out.println(PURPLE + "Thêm mới danh mục thành công!!!" + RESET);
            }
        }
    }
